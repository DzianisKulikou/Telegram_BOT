...
bot: Bot = Bot(token=API_TOKEN)  # присваиваем переменной bot класс Bot() передаём аргумент token=API_TOKEN и делаем проверку на тип Bot
dp: Dispatcher = Dispatcher()  # присваиваем переменной dp класс Dispatcher() и делаем проверку на тип Dispatcher
print('Я ЖИВ!')
